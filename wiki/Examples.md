...
Six complete, deployable dApps live in `examples/`. Each has a Foundry or Hardhat project, a single-file HTML frontend (ethers@6, no bundler), and a `README.md` with deploy instructions.
